...
4. [Building a Software Template](#building-a-software-template)
   ...
   - [Creating a Template Step by Step](#creating-a-template-step-by-step)
     - [A Quick Overview of `template.yaml`](#a-quick-overview-of-templateyaml)
     - [Step 2: Start with a Blank `template.yaml`](#step-2-start-with-a-blank-templateyaml)
     - [Step 2.1: Define User Input Parameters](#step-21-define-user-input-parameters)
     - [Step 2.2: Fetch Quarkus Boilerplate Code](#step-22-fetch-quarkus-boilerplate-code)
     - [Step 2.3: Create a Git Repository and Push Code](#step-23-create-a-git-repository-and-push-code)
     - [Step 2.4: Register the Service in Red Hat Developer Hub](#step-24-register-the-service-in-red-hat-developer-hub)
     - [Step 2.5: Deploy with GitOps & ArgoCD](#step-25-deploy-with-gitops--argocd)
     - [Step 2.6: Publish GitOps Deployment Resources](#step-26-publish-gitops-deployment-resources)
     - [Step 2.7: Configure ArgoCD for Automated Deployment](#step-27-configure-argocd-for-automated-deployment)
     - [Step 2.8: Provide Output Links for Easy Access](#step-28-provide-output-links-for-easy-access)
5. [Building `catalog-info.yaml`](#building-catalog-infoyaml)
   - [Start with a Blank `catalog-info.yaml`](#start-with-a-blank-catalog-infoyaml)
   - [Step 3.1: Add Metadata (Description & Tags)](#step-31-add-metadata-description--tags)
   - [Step 3.2: Add Annotations for GitOps and CI/CD](#step-32-add-annotations-for-gitops-and-cicd)
   - [Step 3.3: Add Developer Links for OpenShift Dev Spaces](#step-33-add-developer-links-for-openshift-dev-spaces)
   - [Step 4: Register the API in Red Hat Developer Hub](#step-4-register-the-api-in-red-hat-developer-hub)
6. [Importing Template in Red Hat Developer Hub](#importing-template-in-red-hat-developer-hub)
